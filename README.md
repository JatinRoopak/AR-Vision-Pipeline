...
## 3. Using Custom 3D Models or Images
  * **3D Models**: Place your .obj files in the src/ directory alongside the scripts.
...
For the 3D models to perfectly lock onto the physical tags without jittering, accurate camera intrinsic parameters are required.
  * Run the `calibration.py` script with multiple images of a standard checkerboard taken by your specific camera.
